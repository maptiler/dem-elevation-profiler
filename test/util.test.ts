...
describe('mToFeet', () => {
  it('converts km to miles', () => {
    expect(mToFeet(1)).toEqual(3.28084)
    expect(mToFeet(10)).toEqual(32.8084)
    expect(mToFeet(100)).toEqual(328.084)
    expect(mToFeet(1000)).toEqual(3280.84)
  })
})
...
describe('distance', () => {
  it('calculates distance between two points', () => {
    ...
    expect(distance([0, 0], [0, 1])).toBeCloseTo(111195.0802335329)
    expect(distance([0, 0], [1, 0])).toBeCloseTo(111195.0802335329)
    expect(distance([0, 0], [1, 1])).toBeCloseTo(157249.5984740402)
    expect(distance([0, 0], [0, 85])).toBeCloseTo(9451581.81985029)
    expect(distance([0, 0], [85, 0])).toBeCloseTo(9451581.81985029)
    expect(distance([0, 0], [80, 80])).toBeCloseTo(9815418.67483913)
  })
})
